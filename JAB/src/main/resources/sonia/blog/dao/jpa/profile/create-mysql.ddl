...
CREATE TABLE JAB_MEMBER (ID BIGINT AUTO_INCREMENT NOT NULL, BlogRole INTEGER NOT NULL, REGISTRATIONDATE DATETIME NOT NULL, ENTRYNOTIFY TINYINT(1) default 0, COMMENTNOTIFY TINYINT(1) default 0, BLOG_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID))
