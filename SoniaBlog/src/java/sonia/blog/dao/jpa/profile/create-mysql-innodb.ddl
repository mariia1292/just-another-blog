...
CREATE TABLE JAB_COMMENT (ID BIGINT AUTO_INCREMENT NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255), SPAM TINYINT(1) default 0, CREATIONDATE DATETIME NOT NULL, ENTRY_ID BIGINT, AUTHOR_ID BIGINT, PRIMARY KEY (ID)) ENGINE InnoDB
...
CREATE TABLE JAB_TRACKBACK (ID BIGINT AUTO_INCREMENT NOT NULL, TYPE INTEGER NOT NULL, URL VARCHAR(255) NOT NULL, EXCERPT VARCHAR(255) NOT NULL, TITLE VARCHAR(255) NOT NULL, TRACKBACKDATE DATETIME NOT NULL, BLOGNAME VARCHAR(255), ENTRY_ID BIGINT, PRIMARY KEY (ID)) ENGINE InnoDB
