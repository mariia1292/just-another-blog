...
CREATE TABLE JAB_BLOG (ID NUMBER(19) NOT NULL, DESCRIPTION VARCHAR2(255) NULL, EMAIL VARCHAR2(255) NULL, TITLE VARCHAR2(250) NOT NULL, ENTRIESPERPAGE NUMBER(10) NULL, CREATIONDATE TIMESTAMP NOT NULL, IMAGEHEIGHT NUMBER(10) NULL, TEMPLATE VARCHAR2(255) NOT NULL, IMAGEWIDTH NUMBER(10) NULL, ALLOWCOMMENTS NUMBER(1) default 0 NULL, LOCALE VARCHAR2(255) NULL, ALLOWMACROS NUMBER(1) default 0 NULL, THUMBNAILHEIGHT NUMBER(10) NULL, DATEFORMAT VARCHAR2(50) NOT NULL, THUMBNAILWIDTH NUMBER(10) NULL, ACTIVE NUMBER(1) default 0 NULL, TIMEZONE VARCHAR2(255) NULL, ALLOWHTMLCOMMENTS NUMBER(1) default 0 NULL, SENDAUTOPING NUMBER(1) default 0 NULL, IDENTIFIER VARCHAR2(255) UNIQUE NOT NULL, PRIMARY KEY (ID))
