...
CREATE TABLE JAB_MEMBER (ID NUMBER(19) NOT NULL, BlogRole NUMBER(10) NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, BLOG_ID NUMBER(19) NULL, USER_ID NUMBER(19) NULL, PRIMARY KEY (ID))
