CREATE TABLE JAB_COMMENT (ID NUMBER(19) NOT NULL, AUTHORADDRESS VARCHAR2(255) NULL, AUTHORMAIL VARCHAR2(255) NULL, CONTENT VARCHAR2(2048) NOT NULL, AUTHORURL VARCHAR2(255) NULL, AUTHORNAME VARCHAR2(255) NOT NULL, SPAM NUMBER(1) default 0 NULL, CREATIONDATE TIMESTAMP NOT NULL, ENTRY_ID NUMBER(19) NULL, PRIMARY KEY (ID))
...
CREATE TABLE JAB_USER (ID NUMBER(19) NOT NULL, PASSWORD VARCHAR2(255) NOT NULL, ACTIVATIONCODE VARCHAR2(255) NOT NULL, EMAIL VARCHAR2(255) UNIQUE NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, NAME VARCHAR2(255) UNIQUE NOT NULL, GLOBALADMIN NUMBER(1) default 0 NULL, LASTLOGIN TIMESTAMP NULL, SELFMANAGED NUMBER(1) default 0 NULL, DISPLAYNAME VARCHAR2(255) NOT NULL, ACTIVE NUMBER(1) default 0 NULL, PRIMARY KEY (ID))
