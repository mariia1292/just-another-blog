CREATE TABLE JAB_CATEGORY (ID BIGINT AUTO_INCREMENT NOT NULL, CREATIONDATE DATETIME NOT NULL, DESCRIPTION VARCHAR(255), NAME VARCHAR(255) NOT NULL, BLOG_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_COMMENT (ID BIGINT AUTO_INCREMENT NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255), SPAM TINYINT(1) default 0, CREATIONDATE DATETIME NOT NULL, ENTRY_ID BIGINT, AUTHOR_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_BLOGHITCOUNT (ID BIGINT AUTO_INCREMENT NOT NULL, HITDATE DATE NOT NULL, HITCOUNT BIGINT, BLOG_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_USER (ID BIGINT AUTO_INCREMENT NOT NULL, PASSWORD VARCHAR(255) NOT NULL, ACTIVATIONCODE VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, REGISTRATIONDATE DATETIME NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, GLOBALADMIN TINYINT(1) default 0, LASTLOGIN DATETIME, SELFMANAGED TINYINT(1) default 0, DISPLAYNAME VARCHAR(255) NOT NULL, HOMEPAGE VARCHAR(255), AVATAR VARCHAR(255), ACTIVE TINYINT(1) default 0, PRIMARY KEY (ID))
CREATE TABLE JAB_TAG (ID BIGINT AUTO_INCREMENT NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, PRIMARY KEY (ID))
CREATE TABLE JAB_ATTACHMENT (ID BIGINT AUTO_INCREMENT NOT NULL, FILESIZE BIGINT NOT NULL, CREATIONDATE DATETIME NOT NULL, MIMETYPE VARCHAR(255) NOT NULL, DESCRIPTION VARCHAR(255), NAME VARCHAR(255) NOT NULL, FILEPATH VARCHAR(255) NOT NULL, ENTRY_ID BIGINT, PAGE_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_ENTRY_JAB_TAG (entries_ID BIGINT NOT NULL, tags_ID BIGINT NOT NULL, PRIMARY KEY (entries_ID, tags_ID))
CREATE TABLE JAB_BLOG (ID BIGINT AUTO_INCREMENT NOT NULL, DESCRIPTION VARCHAR(255), EMAIL VARCHAR(255), TITLE VARCHAR(250) NOT NULL, STARTPAGE VARCHAR(255), ENTRIESPERPAGE INTEGER, CREATIONDATE DATETIME NOT NULL, IMAGEHEIGHT INTEGER, TEMPLATE VARCHAR(255) NOT NULL, IMAGEWIDTH INTEGER, ALLOWCOMMENTS TINYINT(1) default 0, LOCALE VARCHAR(255), ALLOWMACROS TINYINT(1) default 0, THUMBNAILHEIGHT INTEGER, DATEFORMAT VARCHAR(50) NOT NULL, THUMBNAILWIDTH INTEGER, ACTIVE TINYINT(1) default 0, TIMEZONE VARCHAR(255), ALLOWHTMLCOMMENTS TINYINT(1) default 0, SENDAUTOPING TINYINT(1) default 0, IDENTIFIER VARCHAR(255) UNIQUE NOT NULL, PRIMARY KEY (ID))
CREATE TABLE JAB_BLOGPARAMETER (ID BIGINT AUTO_INCREMENT NOT NULL, NAME VARCHAR(255) NOT NULL, VALUE VARCHAR(255) NOT NULL, BLOG_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_MEMBER (ID BIGINT AUTO_INCREMENT NOT NULL, BlogRole INTEGER NOT NULL, REGISTRATIONDATE DATETIME NOT NULL, NOTIFY TINYINT(1) default 0, BLOG_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE JAB_ENTRY (ID BIGINT AUTO_INCREMENT NOT NULL, PUBLISHED TINYINT(1) default 0, ALLOWCOMMENTS TINYINT(1) default 0, TEASER VARCHAR(4000), PUBLISHINGDATE DATETIME, CREATIONDATE DATETIME NOT NULL, TITLE VARCHAR(255) NOT NULL, LASTUPDATE DATETIME, CONTENT TEXT(64000), AUTHOR_ID BIGINT, BLOG_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_PAGE (ID BIGINT AUTO_INCREMENT NOT NULL, PUBLISHINGDATE DATETIME, NAVIGATIONPOSITION INTEGER, NAVIGATIONTITLE VARCHAR(255) NOT NULL, PUBLISHED TINYINT(1) default 0, CREATIONDATE DATETIME NOT NULL, CONTENT TEXT(64000), TITLE VARCHAR(255) NOT NULL, LASTUPDATE DATETIME, AUTHOR_ID BIGINT, PARENT_ID BIGINT, BLOG_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE JAB_TRACKBACK (ID BIGINT AUTO_INCREMENT NOT NULL, TYPE INTEGER NOT NULL, URL VARCHAR(255) NOT NULL, EXCERPT VARCHAR(255) NOT NULL, TITLE VARCHAR(255) NOT NULL, TRACKBACKDATE DATETIME NOT NULL, BLOGNAME VARCHAR(255), ENTRY_ID BIGINT, PRIMARY KEY (ID))
