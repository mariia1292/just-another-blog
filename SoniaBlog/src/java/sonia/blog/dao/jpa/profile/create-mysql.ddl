...
CREATE TABLE JAB_COMMENT (ID BIGINT AUTO_INCREMENT NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255) NOT NULL, SPAM TINYINT(1) default 0, CREATIONDATE DATETIME NOT NULL, ENTRY_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE JAB_USER (ID BIGINT AUTO_INCREMENT NOT NULL, PASSWORD VARCHAR(255) NOT NULL, ACTIVATIONCODE VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, REGISTRATIONDATE DATETIME NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, GLOBALADMIN TINYINT(1) default 0, LASTLOGIN DATETIME, SELFMANAGED TINYINT(1) default 0, DISPLAYNAME VARCHAR(255) NOT NULL, ACTIVE TINYINT(1) default 0, PRIMARY KEY (ID))
