...
CREATE TABLE JAB_MEMBER (ID BIGINT AUTO_INCREMENT NOT NULL, BlogRole INTEGER NOT NULL, REGISTRATIONDATE DATETIME NOT NULL, BLOG_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID))
