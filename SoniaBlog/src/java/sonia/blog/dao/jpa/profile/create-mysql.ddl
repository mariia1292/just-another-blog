...
CREATE TABLE JAB_TRACKBACK (ID BIGINT AUTO_INCREMENT NOT NULL, URL VARCHAR(255) NOT NULL, EXCERPT VARCHAR(255) NOT NULL, TITLE VARCHAR(255) NOT NULL, TRACKBACKDATE DATETIME NOT NULL, BLOGNAME VARCHAR(255) NOT NULL, ENTRY_ID BIGINT, PRIMARY KEY (ID))
