CREATE TABLE JAB_COMMENT (ID  SERIAL NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255), SPAM BOOLEAN, CREATIONDATE TIMESTAMP NOT NULL, ENTRY_ID BIGINT, AUTHOR_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE JAB_USER (ID  SERIAL NOT NULL, PASSWORD VARCHAR(255) NOT NULL, ACTIVATIONCODE VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, GLOBALADMIN BOOLEAN, LASTLOGIN TIMESTAMP, SELFMANAGED BOOLEAN, DISPLAYNAME VARCHAR(255) NOT NULL, HOMEPAGE VARCHAR(255), AVATAR VARCHAR(255), ACTIVE BOOLEAN, PRIMARY KEY (ID))
...
CREATE TABLE JAB_BLOGPARAMETER (ID  SERIAL NOT NULL, NAME VARCHAR(255) NOT NULL, VALUE VARCHAR(255) NOT NULL, BLOG_ID BIGINT, PRIMARY KEY (ID))
