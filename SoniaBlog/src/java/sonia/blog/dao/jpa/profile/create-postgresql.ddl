...
CREATE TABLE JAB_USER (ID  SERIAL NOT NULL, PASSWORD VARCHAR(255) NOT NULL, ACTIVATIONCODE VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, GLOBALADMIN BOOLEAN, LASTLOGIN TIMESTAMP, SELFMANAGED BOOLEAN, DISPLAYNAME VARCHAR(255) NOT NULL, HOMEPAGE VARCHAR(255), ACTIVE BOOLEAN, PRIMARY KEY (ID))
