...
CREATE TABLE JAB_BLOG (ID  SERIAL NOT NULL, DESCRIPTION VARCHAR(255), EMAIL VARCHAR(255), TITLE VARCHAR(250) NOT NULL, STARTPAGE VARCHAR(255), ENTRIESPERPAGE INTEGER, CREATIONDATE TIMESTAMP NOT NULL, IMAGEHEIGHT INTEGER, TEMPLATE VARCHAR(255) NOT NULL, IMAGEWIDTH INTEGER, ALLOWCOMMENTS BOOLEAN, ALLOWTRACKBACKS, LOCALE VARCHAR(255), ALLOWMACROS BOOLEAN, THUMBNAILHEIGHT INTEGER, DATEFORMAT VARCHAR(50) NOT NULL, THUMBNAILWIDTH INTEGER, ACTIVE BOOLEAN, TIMEZONE VARCHAR(255), ALLOWHTMLCOMMENTS BOOLEAN, SENDAUTOPING BOOLEAN, IDENTIFIER VARCHAR(255) UNIQUE NOT NULL, PRIMARY KEY (ID))
