CREATE TABLE JAB_COMMENT (ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255), SPAM SMALLINT DEFAULT 0, CREATIONDATE TIMESTAMP NOT NULL, TYPE INTEGER NOT NULL, ENTRY_ID BIGINT, AUTHOR_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE JAB_USER (ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL, PASSWORD VARCHAR(255) NOT NULL, ACTIVATIONCODE VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, NAME VARCHAR(255) UNIQUE NOT NULL, GLOBALADMIN SMALLINT DEFAULT 0, LASTLOGIN TIMESTAMP, SELFMANAGED SMALLINT DEFAULT 0, DISPLAYNAME VARCHAR(255) NOT NULL, HOMEPAGE VARCHAR(255), AVATAR VARCHAR(255), ACTIVE SMALLINT DEFAULT 0, PRIMARY KEY (ID))
...
CREATE TABLE JAB_MEMBER (ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL, BlogRole INTEGER NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, ENTRYNOTIFY SMALLINT DEFAULT 0, COMMENTNOTIFY SMALLINT DEFAULT 0, BLOG_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE JAB_COMMENT ADD CONSTRAINT JABCOMMENTAUTHOR_ID FOREIGN KEY (AUTHOR_ID) REFERENCES JAB_USER (ID)
