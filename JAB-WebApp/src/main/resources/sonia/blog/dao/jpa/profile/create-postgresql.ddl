CREATE TABLE JAB_COMMENT (ID  SERIAL NOT NULL, AUTHORADDRESS VARCHAR(255), AUTHORMAIL VARCHAR(255), CONTENT VARCHAR(2048) NOT NULL, AUTHORURL VARCHAR(255), AUTHORNAME VARCHAR(255), SPAM BOOLEAN, CREATIONDATE TIMESTAMP NOT NULL, TYPE INTEGER NOT NULL, ENTRY_ID BIGINT, AUTHOR_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE JAB_BLOG (ID  SERIAL NOT NULL, DESCRIPTION VARCHAR(255), EMAIL VARCHAR(255), TITLE VARCHAR(250) NOT NULL, STARTPAGE VARCHAR(255), ENTRIESPERPAGE INTEGER, CREATIONDATE TIMESTAMP NOT NULL, IMAGEHEIGHT INTEGER, TEMPLATE VARCHAR(255) NOT NULL, IMAGEWIDTH INTEGER, ALLOWCACHING BOOLEAN, ALLOWCOMMENTS BOOLEAN, ALLOWTRACKBACKS BOOLEAN, LOCALE VARCHAR(255), ALLOWMACROS BOOLEAN, THUMBNAILHEIGHT INTEGER, DATEFORMAT VARCHAR(50) NOT NULL, THUMBNAILWIDTH INTEGER, ACTIVE BOOLEAN, TIMEZONE VARCHAR(255), ALLOWHTMLCOMMENTS BOOLEAN, SENDAUTOPING BOOLEAN, IDENTIFIER VARCHAR(255) UNIQUE NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE JAB_MEMBER (ID  SERIAL NOT NULL, BlogRole INTEGER NOT NULL, REGISTRATIONDATE TIMESTAMP NOT NULL, ENTRYNOTIFY BOOLEAN, COMMENTNOTIFY BOOLEAN, BLOG_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID))
